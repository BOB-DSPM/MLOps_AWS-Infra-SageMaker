                    ...
                    "phases": {
                        ...
                        "build": {
                            "commands": [
                                ...
                                "        except Exception as e:\n"
                                "          print(f'ERROR: Model data not found at {model_url}: {e}')\n"
                                "          raise SystemExit(f'Model package {mp} has invalid model data location')\n"
                                "except Exception as e:\n"
                                "  print(f'ERROR: Failed to verify model package: {e}')\n"
                                "  raise SystemExit('Model package verification failed')\n"
